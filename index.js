...
//будем выводить новости из массива данных выше
const mainNews = data.items.slice(0, 3);//мы берем массив данных items и обрезаем с 0 до 3( то есть берем только три новости)
const smallNews = data.items.slice(3, 12);

//напишем функцию для экраннированных тегов( от хакеров)
    ...
    template.innerHTML = ` 
     <article class="main-article">
         <div class="main-article__image-container">
             ...
             <!--encodeURI - экраннирует ссылки, то есть защищает от хакеров( я так понимаю встроенный метод) -->
         </div>
         <div class="main-article__content">
             <span class="article-category main-article__category">${escapeString(categoryDate.name)}</span>
             <!--Сам по себе <span> не несет никакого смысла и не влияет на структуру документа.
     Используется как вспомогательный элемент для стилизации или манипуляции контентом. -->
