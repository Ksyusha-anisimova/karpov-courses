export const data = {
  ...
  "items": [{
    ...
    "id": 87867,
    "lang": "ru",
    "date": "Mon Oct 10 2021 16:48:54 GMT+0300 (Moscow Standard Time)",
...
export const mainNews = data.items.slice(0, 3);
export const smallNews = data.items.slice(3, 12);
...
export const escapeString = string => {
  ...
  }); // Заменяем найденные символы в строке
};
...
//                     {/*                <span*/}
//                     {/*                    className="article-category main-article__category">${articles.categories.find(({id}) => )}</span>*/}
...
//                     {/*                <span*/}
//                     {/*                    className="article-source main-article__source">${escapeString(sourcesDate.name)}</span>*/}
//                     {/*            </div>*/}
//                     {/*        </article>*/}
//                     {/*    )*/}
//                     {/*})}*/}
...
//             const template = document.createElement('template');// Создаем HTML-шаблон
//             const dateDate = new Date(item.date).toLocaleDateString('ru-RU', {month: 'long', day: 'numeric'});// Форматируем дату
//             const sourcesDate = data.sources.find((sourcesItem) => sourcesItem.id === item.source_id);// Находим источник
//
//             template.innerHTML = `
...
// Отрисовываем главный компонент приложения в контейнер с id "root"
// ReactDOM.render(<App/>, document.getElementById("root")); пишет что это устаревший способ

//новый способ для реакт 18 и выше
import React from "react";
import { createRoot } from "react-dom/client";
import { App } from "./App.js";
const rootElement = document.getElementById("root");
const root = createRoot(rootElement); // ✅ Новый способ
